...
export default [
    null,
    { type: "genre", question: "What genre do you want to play?", component: "base", change: true, data: igdb.getGenres },
    { type: "theme", question: "What topic should the in game?", component: "base", change: true, data: igdb.getThemes },
